...
but1=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=openfile,text='Image',font=('helvetica 15 bold'))
but1.place(x=5,y=104)
...
but3=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=openfile,text='web-cam',font=('helvetica 15 bold'))
but3.place(x=5,y=250)
